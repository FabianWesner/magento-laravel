...
The current Magento 1 runtime is built around Magento 1/Zend-era framework patterns, static access through `Mage`, XML configuration, legacy controllers, blocks, observers, and resource models.
