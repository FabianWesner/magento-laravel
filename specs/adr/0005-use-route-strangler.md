...
Migrate route groups and workflows incrementally. Laravel owns selected migrated routes while legacy Magento handles unmigrated routes through fallback.
