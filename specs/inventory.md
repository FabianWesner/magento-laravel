...
The current root checkout is expected to be core-only unless a project overlay is added. The local Magento CE `1.9.4.5` mirror baseline is documented in `specs/modernization/install-verification.md`.
