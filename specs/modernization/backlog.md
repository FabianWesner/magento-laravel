...
| --- | --- | --- | --- |
| Add real project code locally | Repository access | Project overlay and Magento CE `1.9.4.5` core/mirror are available in one workspace. | `git status`, module inventory. |
