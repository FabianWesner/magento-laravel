...
| DEF-005 | P1 | Open | modernization | AD-001, AD-012, SF-010, SF-007 through SF-009 | Final route fallback and auth/security gates report ADR 0008 is not approved. Scoped foundation evidence exists at `specs/modernization/route-fallback-evidence.md` and `specs/modernization/auth-security-evidence.md`, but ADR 0008 remains `Proposed`. | Release is blocked; no acceptance granted. | None | None | Approve or revise ADR 0008, then rerun route fallback and auth/security final checks. | Do not move authenticated storefront, cart, checkout, API, or admin routes to final cutover. |
