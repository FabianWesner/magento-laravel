...
class DomainCatalog
{
    ...
    public function all(): array
    {
        return [
            ...
            'checkout_step' => new DomainFeature('checkout_step', 'CheckoutStep', 'Checkout steps', ['SF-008', 'CB-001', 'CB-007', 'CB-008', 'CB-010'], ['login', 'billing', 'shipping', 'shipping method', 'payment', 'review', 'agreement'], true),
            'checkout_payment' => new DomainFeature('checkout_payment', 'CheckoutPayment', 'Checkout payment', ['SF-008', 'SF-015', 'CB-008'], ['checkmo', 'banktransfer', 'free', 'paypal express', 'failed payment', 'payment review'], true),
            'checkout_review' => new DomainFeature('checkout_review', 'CheckoutReview', 'Checkout review', ['SF-008', 'CB-003', 'CB-006', 'CB-008', 'CB-010'], ['review totals', 'agreement required', 'place order blocked', 'success preview', 'failure preview'], true),
            'multishipping' => new DomainFeature('multishipping', 'Multishipping', 'Multishipping checkout', ['SF-009', 'CB-001', 'CB-007', 'CB-008', 'CB-010'], ['addresses', 'methods', 'billing', 'overview', 'place order blocked'], true),
