...
- Feature-ID traceability, fixtures, characterization, parity tests, visual regression, edge-case verification, security, performance, and operations gates.
- Technologies that must be removed from the Laravel target.
