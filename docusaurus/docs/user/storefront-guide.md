...
The storefront guide documents customer-facing behavior preserved from Magento CE `1.9.4.5`.
...
Each topic must link to Magento and Laravel screenshots, fixture IDs, and browser tests.
